...
from FightScheduler.serializers import StatusCodeSerializer,AccountInfoSerializer,AccountTypeSerializer,RoleSerializer,AddressSerializer,PersonSerializer,OrganizationSerializer,ServiceSerializer,AllowableServiceSerializer,AffiliationSerializer,PersonalInformationSerializer,CareerSerializer,NonBoxerInfoSerializer,WaiverSerializer,WaiverRequirementSerializer,SignatureSerializer,SignedWaiverSerializer,MedicalCertSerializer,ServiceEnrollmentSerializer,MatchResultCodeSerializer,SeriesSerializer,ShowSerializer,MatchSerializer,MatchRoundSerializer,AvailabilityScheduleSerializer# @SERIALIZER_IMPORTS@
from FightScheduler.forms import StatusCodeForm,AccountInfoForm,AccountTypeForm,RoleForm,AddressForm,PersonForm,OrganizationForm,ServiceForm,AllowableServiceForm,AffiliationForm,PersonalInformationForm,CareerForm,NonBoxerInfoForm,WaiverForm,WaiverRequirementForm,SignatureForm,SignedWaiverForm,MedicalCertForm,ServiceEnrollmentForm,MatchResultCodeForm,SeriesForm,ShowForm,MatchForm,MatchRoundForm,AvailabilityScheduleForm,# @FORM_IMPORTS@
...
class AccountInfoViewSet(viewsets.ModelViewSet): #@DEFAULT@
...
class AvailabilityScheduleViewSet(viewsets.ModelViewSet): #@DEFAULT@
